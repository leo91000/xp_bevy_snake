...
fn collision_system(
    ...
    mut snake_query: Query<(&mut PointList, Entity), (With<Snake>, Without<Obstacle>)>,
    mut obstacle_query: Query<(&mut PointList, Entity), (With<Obstacle>, Without<Snake>)>,
